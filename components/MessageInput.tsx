          ...
          {images.map((img, i) => (
            <div key={i} className="relative flex-shrink-0">
              {img.mediaType.startsWith('image/') ? (
                ...
                <div className="h-16 w-16 rounded-lg border border-gray-300 dark:border-gray-600
                  bg-gray-100 dark:bg-gray-800 flex flex-col items-center justify-center px-1">
